        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="mt-3">
                            <a href="{{ route('admin.test.index') }}"><i class="fas fa-arrow-circle-left"
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <a href="{{ route('admin.test.question.create',['id' => $test_id]) }}"
                                    class="btn btn-primary">Create Questions</a>
                            </div>
