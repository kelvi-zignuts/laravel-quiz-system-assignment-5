    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                <div class="mt-3">
                            <a href="{{route('tests.show',['id'=>$test_id])}}" ><i class="fas fa-arrow-circle-left" style="margin-left:10px; font-size:20px;"></i></a>
                        </div>
                                    ...
                                    <tr>
                                       ...
                                       <td style="vertical-align:top;">{{strtoupper($question->correct_option)}}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('test-module.questions.edit',['id'=>$question->id])}}" style="margin-left:30px;" >
